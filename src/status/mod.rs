...
use self::net::{handle_packet_received_event, handle_packet_sent_event, handle_server_tick_event, PacketReceivedEvent, PacketSentEvent, ServerSocket, StatusServerTickEvent, StatusServerTicker};

pub fn init(world_helper: &mut WorldHelper) {
    world_helper
        .add_event::<PacketReceivedEvent>()
        .add_event::<PacketSentEvent>()
